 ...
 * the roller (pool, mode, type, TN…) and [title] labels what is being rolled ("Iniziativa",
 * "Attacco — Katana"). Held transiently in [com.l5rcm.companion.ui.AppViewModel.pendingDice] until
